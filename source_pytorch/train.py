...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_features', type=int, default=3, metavar='IN',
                        help='Number of input features of the document to categorize (default: 2)')
    parser.add_argument('--hidden_dim', type=int, default=20, metavar='N_DIM',
                        help='Number of hidden layers of the classifier (default: 20)')
    parser.add_argument('--output_dim', type=int, default=1, metavar='OUT',
                        help='Output dimension: ~0 means not plagiarized; ~1 means plagiarized (default: 1)')
